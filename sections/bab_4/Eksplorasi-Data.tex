...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/curah-hujan-barat.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/curah-hujan-selatan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/curah-hujan-tengah.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/curah-hujan-timur.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/curah-hujan-utara.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/boxplot-semua-wilayah.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/bab_4/bab_4.1/seasonal-decompose-semua-wilayah.png}
...
\input{tables/bab_4/Korelasi-Setiap-Wilayah.tex}
