...
Berdasarkan Tabel~\ref{table:estimasi-parameter-arima} dapat dilihat bahwa model terbaik SARIMA, yaitu $(1,1,0) \times (0,1,0)_{12}$ dan $(1,1,0) \times (1,1,0)_{12}$ yang masing-masing menunjukkan nilai p-value <0.05, yang berarti seluruh parametre AR non seasonal dan seasonal signifikan secara statistik.
