...
\begin{enumerate}
    ...
    Dijelaskan juga perkembangan model spasio-temporal seperti STARIMA yang dapat menangkap ketergantungan antar lokasi dan antar waktu.
    ...
    Analisis eksploratif mencakup visualisasi pola spasial dan temporal. Setelah itu dilakukan uji kestasioneran, pembentukan tiga jenis Spatial Weight Matrix, serta pembangunan model baseline ARIMA.
    Setelah ARIMA, dibangun model STARMA dengan tiga jenis bobot: seragam, invers jarak, dan korelasi silang.
    ...
    Selanjutnya hasil ARIMA ditampilkan: uji stasioner, estimasi parameter, fitting model, dan grafik peramalan untuk tiap wilayah. \\
    Bagian terbesar membahas STARMA. Setiap jenis bobot (seragam, invers jarak, korelasi silang) dianalisis dari:
    ...
    Bab ini menunjukkan bahwa pembobotan tertentu memberikan RMSE paling rendah dan model STARMA lebih unggul dibanding ARIMA.
    ...
    \begin{enumerate}[label=\alph*.]
        ...
        \item Pembobotan spasial memengaruhi performa STARMA secara signifikan.
        \item Model STARMA tertentu menghasilkan prediksi terbaik berdasarkan RMSE.
    \end{enumerate}
