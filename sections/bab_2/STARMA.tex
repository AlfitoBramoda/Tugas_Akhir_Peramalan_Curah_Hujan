...
\begin{enumerate}
    ...
    Setelah orde ($p$, $q$, $\lambda$, $\mu$) dan matriks bobot spasial ditentukan, parameter model STARMA diestimasi. Estimasi parameter STARMA menggunakan Maximum Likelihood Estimation
    Langkah-langkah estimasi Maximum Likelihood Estimation:
    \begin{enumerate}[label=\alph*)]
        ...
        \begin{enumerate}[label=\roman*)]
            ...
            \begin{itemize}
                ...
                \item terima $H_0$ jika $|$t\textsubscript{hitung}$|$ $<$ $|$t\textsubscript{tabel}$|$ artinya parameter tidak signifikan
                \item tolak $H_0$ jika $|$t\textsubscript{hitung}$|$ $>$ $|$t\textsubscript{tabel}$|$ artinya parameter signifikan.
            \end{itemize}
    ...
    Jika anda membagi data, evaluasi kinerja Peramalan model pada data pengujian menggunakan metriks akurasi seperti RMSE
\end{enumerate}
