...
\begin{enumerate}
    ...
    \begin{equation}
        W_t = \phi_1 W_{t-1} + \cdots + \phi_p W_{t-p}
            - \theta_1 u_{t-1} - \cdots - \theta_q u_{t-q} + u_t
        \label{eq:arma_wt}
    \end{equation}
    Sebagian deret waktu bersifat tiak stasioner terhadap mean, sehingga diperlukan proses differensiasi untuk membuatnya stasioner. 
